    ...
    <>
      ...
      <div className="grid grid-cols-2 w-full h-full">
        ...
        <div className="flex flex-col pt-50">
          ...
          <p className="pb-2">hover:scale-105 hover:shadow-[0_6px_10px_rgba(255,192,203,0.5)] hover:transition-all hover:duration-500 hover:ease-in-out</p>
          <p className="text-xl font-bold">focus</p>
          <p className="pb-2">focus:scale-105 focus:shadow-[0_6px_10px_rgba(255,192,203,0.5)] focus:outline-none focus:ring-4 focus:ring-purple-300 focus:transition-all focus:duration-500 focus:ease-in-out</p>
          <p className="text-xl font-bold">active</p>
          <p className="pb-2">active:translate-y-1 active:transition-all active:duration-500 active:ease-in-out</p>
        </div>
      </div>
    </>
  );
